...
def compute_HIC(t, a):
    ...
    # Calculate the integral curve, replacing a with a_g
    ...
    for i in range(n - 1):
        for j in range(i + 1, n):
            ...
            a_avg = area_ij / dt_ij  # Average acceleration (unit: g)
...
def compute_injury_metrics(sol, t, params):
    ...
    1. HIC (based on 2D resultant acceleration)
    ...
    x1, y1 = sol[0], sol[2]  # Chest coordinates
    x2, y2 = sol[4], sol[6]  # Abdomen coordinates
